...
namespace Microsoft.Extensions.HealthChecks
{
    ...
    public abstract class HealthCheckService
    {
        ...
        /// instance itself.
        /// </remarks>
        public abstract IReadOnlyDictionary<string, IHealthCheck> Checks { get; }
        ...
        /// </returns>
        public abstract Task<CompositeHealthCheckResult> CheckHealthAsync(CancellationToken cancellationToken = default);
    }
}
